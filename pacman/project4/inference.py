...
class ExactInference(InferenceModule):
  ...
  def elapseTime(self, gameState):
    ...
    for oldPosition in positions:
        newDist = self.getPositionDistribution(self.setGhostPosition(gameState, oldPosition))
        for newPosition, dist in newDist.items():
            newBeliefs[newPosition]+=self.beliefs[oldPosition]*dist
